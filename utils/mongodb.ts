...
class Mongo {
    ...
    public async updateOne(collectionName: string, filter: Record<string, any>, data: Record<string, any>) {
    ...
    public async updateMany(collectionName: string, filter: Record<string, any>, data: Record<string, any>) {
        console.log("updating data...")
        try {
            const collection = this.db?.collection<Fields>(collectionName)
            if (collection) {
    ...
    public async distinct(collectionName: string, field: string, filter: Record<string, any>) {
