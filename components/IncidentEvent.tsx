...
export default function IncidentEvent(opts: {eventList: eventListInterface[], month: string}) {
    ...
    return (
        <div className="md-px-10 px-7 font-400 dark:bg-gray-800 dark:text-white">
            ...
            <div onClick={toggleShowHandler} className="border-0.5 border-gray-200 md-h-10 h-8 text-gray-400 flex justify-center items-center mb-6 relative top--0.3 bg-white text-gray-500 hover:bg-gray-50 hover:cursor-pointer shadow hover:border-gray-300 active:pl-1 active:pt-1 active:relative dark:bg-gray-800 dark:text-white">
