...
export default function IncidentEvent(opts: {eventList: {eventTitle:string, eventSubTitle: string, time: number, status: testStatus }[], month: string}) {
    ...
    return (
        <div className="md-px-10 px-7 font-400">
            <h2 className="text-7">{opts.month}</h2>
            ...
            <div className="border-0.5 md-h-10 h-8 text-gray-400 flex justify-center items-center mb-6 relative top--0.3 bg-white text-gray-500 hover:bg-gray-50 hover:cursor-pointer shadow hover:border-gray-300 active:pl-1 active:pt-1 active:relative">
